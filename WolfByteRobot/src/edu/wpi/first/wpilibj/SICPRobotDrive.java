...
//This is an editted version of the Robot Drive class. The purpose was to change the Talons to Victors. 

public class SICPRobotDrive implements MotorSafety {
   ...
   * channels are specified in the call. This call assumes Victors for
   * controlling the motors.
   *$
   ...
   */
  public SICPRobotDrive(SpeedController leftMotor, SpeedController rightMotor) {
   ...
   *        the robot.
   */
  public SICPRobotDrive(SpeedController frontLeftMotor, SpeedController rearLeftMotor,
